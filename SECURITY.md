...
For CrateDB, just navigate to [Report a vulnerability for CrateDB Agent Skills].
...
[Report a vulnerability for CrateDB Agent Skills]: https://github.com/crate/agent-skills/security/advisories/new
